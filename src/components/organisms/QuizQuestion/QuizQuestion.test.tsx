...
describe('QuizQuestion', () => {
  it('renders question text', () => {
    render(<QuizQuestion question={mockQuestion} questionNumber={1} total={10} selectedIndex={null} revealed={false} onSelect={() => {}} onSubmit={() => {}} onNext={() => {}} isLast={false} topicLabel="IRPCS" />)
  ...
  it('calls onSelect when option clicked', async () => {
    ...
    render(<QuizQuestion question={mockQuestion} questionNumber={1} total={10} selectedIndex={null} revealed={false} onSelect={onSelect} onSubmit={() => {}} onNext={() => {}} isLast={false} topicLabel="IRPCS" />)
    await userEvent.setup().click(screen.getByText('Give-way vessel'))
    expect(onSelect).toHaveBeenCalledWith(1)
  })

  it('shows explanation after reveal', () => {
    render(<QuizQuestion question={mockQuestion} questionNumber={1} total={10} selectedIndex={1} revealed={true} onSelect={() => {}} onSubmit={() => {}} onNext={() => {}} isLast={false} topicLabel="IRPCS" />)
  ...
  it('shows See Results on last question after reveal', () => {
    render(<QuizQuestion question={mockQuestion} questionNumber={10} total={10} selectedIndex={1} revealed={true} onSelect={() => {}} onSubmit={() => {}} onNext={() => {}} isLast={true} topicLabel="IRPCS" />)
    expect(screen.getByText('See Results')).toBeInTheDocument()
  })

  it('shows QUESTION label with number', () => {
    render(<QuizQuestion question={mockQuestion} questionNumber={5} total={10} selectedIndex={null} revealed={false} onSelect={() => {}} onSubmit={() => {}} onNext={() => {}} isLast={false} topicLabel="IRPCS" />)
